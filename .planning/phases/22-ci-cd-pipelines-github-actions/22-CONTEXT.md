# Phase 22: CI/CD Pipelines (GitHub Actions) - Context
...
Code changes are automatically built, tested, and deployed to AKS via GitHub Actions with zero-downtime deployments
