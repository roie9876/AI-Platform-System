...
│   ├── api-gateway/          # NestJS — public API + APIM backend
│   ├── model-service/        # NestJS — model catalog, deployment orchestration
│   ├── inference-proxy/      # NestJS — unified inference routing
│   ├── auth-service/         # NestJS — Entra ID integration, RBAC
│   ├── billing-service/      # NestJS — usage metering, quota management
│   ├── data-service/         # NestJS — dataset/evaluation management
│   └── cli/                  # Platform CLI tool
├── packages/
│   ├── shared-types/         # TypeScript types shared across services
│   ├── sdk/                  # Platform SDK for consumers
│   ├── ui/                   # Shared UI components (shadcn-based)
│   └── config/               # Shared ESLint/TypeScript/Tailwind configs
├── infra/
│   ├── bicep/                # Bicep modules for Azure resources
...
pnpm add @nestjs/core @nestjs/common @nestjs/platform-express @nestjs/microservices rxjs reflect-metadata
pnpm add @azure/identity @azure/cosmos @azure/openai @azure/service-bus @azure/event-hubs
pnpm add @azure/storage-blob @azure/keyvault-secrets
pnpm add bullmq ioredis zod pino helmet @grpc/grpc-js

# Frontend
pnpm add next@16 react@19 react-dom@19
pnpm add @tanstack/react-query recharts zustand
...
# Dev dependencies
pnpm add -D typescript @types/node vitest playwright eslint prettier
pnpm add -D @nestjs/cli @nestjs/testing @nestjs/schematics
pnpm add -D turbo prisma
```
...
---
*Stack research for: Enterprise AI Platform System (Azure-native)*
*Researched: 2026-03-23*
